          ...
          <div class="card-wrapper">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <h3 class="mb-0">Peramalan</h3>
              </div>
              <!-- Card body -->
              <div class="card-body">
                <form action="hasil_peramalan.php" method="get" class="needs-validation" novalidate>
                  <div class="form-group">
                    <label class="form-control-label" for="validationCustom01">Peramalan untuk 12 periode (bulan) kedepan dengan metode Holt-Winter</label>
                    <input type="hidden" name="id_wisata" id="id_wisata" value="7">
                  </div>
                  <button class="btn btn-success" type="submit">Ramalkan</button>
                </form>
              </div>
            </div>
          </div>
